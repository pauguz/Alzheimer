...
class ApiService{
  Future<Usuario?> validarUsuario(String email, String password) async{
    final url= Uri.parse('https://githubusercontent.com/petrlikperu/flutter/main/usuarios.json');
  ...
  final response= await http.get(Uri.parse('https://githubusercontent.com/pruebaflutter1975/DATASETUNFV/main/usuarios.json'), );
  if(response.statusCode==200){
